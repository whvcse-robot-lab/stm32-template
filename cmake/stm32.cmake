MACRO(stm32_create_target)
    ...
    message(STATUS "Board stm32 cpu type: ${CREATETARGET_CPU_TYPE}")
    message(STATUS "Stm32CUBEMX project directory: ${CREATETARGET_CUBEMX_DIR}")
    ...
    # Fixup compile options for each stm32 cpu type
    include(${CMAKE_CURRENT_LIST_DIR}/cmake/${STM32_CPU_TYPE}.cmake)
